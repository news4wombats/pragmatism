...
\usepackage[width=6.5in,height=9.5in,top=.5in,centering]{geometry}
...
\paragraph{Prefatory note:} The following pages present the substance of a course of \ldots\ %twelve
...
%Acknowledgment for permission to reprint is extended to \emph{The Atlantic Monthly}, \emph{The International Journal of Ethics}, \emph{The American Journal of Sociology}, and to \emph{The Commons}.
